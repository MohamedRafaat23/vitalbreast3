...
class _BodyDoctorScreenState extends State<BodyDoctorScreen> {
  ...
  Future<void> fetchDoctors() async {
    try {
      final response = await DioHelper.dio.get('${ApiConstant.baseUrl}/clinic/doctors/');
    ...
    return Expanded(
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return DoctorCard(
            name: doctor.user ?? 'Unknown Doctor',
            specialty: doctor.clinics?.firstOrNull?.city ?? 'General',
